	...
	<div class="row d-flex justify-content-center mt-4">
		<div class="col-6 mt-4"
			...
			<sf:form class="form" id="form2" method="POST"
				action="${base }/taikhoan" modelAttribute="user"
				...
				<div class="form-group d-flex justify-content-center">
					<div class="text-center">
						...
						<div onclick="avtup()" id="showavt"
							style="border: 1px dashed #ccc;width: 10rem;height: 10rem;border-radius: 10rem;background: url('${base}/dulieu/${user.avata }')no-repeat center ; background-size: cover;">
						</div>
					</div>
